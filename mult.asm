section .data
    ...
    msg_resultado db "Multiplicacao: ", 0
    newline db 10, 0
...
section .bss
    ...
    resultado resd 1       ; Armazenar o resultado da multiplicação
    primeiro_numero resb 1 ; Flag para armazenar o primeiro número
...
_start:
    ...
    mov byte [primeiro_numero], 1 ; Sinalizar que é o primeiro número
    mov dword [resultado], 1      ; Inicializar resultado com 1
...
ler_arquivo:
    ...
    ; Se for o primeiro número, inicializar o resultado com ele
    cmp byte [primeiro_numero], 1
    jne continuar_multiplicacao
    mov [resultado], eax
    mov byte [primeiro_numero], 0
    jmp ler_arquivo

continuar_multiplicacao:
    ; Multiplicar pelo resultado total corretamente
    mov ecx, [resultado]   ; Carrega o valor atual do resultado
    imul ecx, eax          ; Multiplica pelo novo número
    mov [resultado], ecx   ; Armazena o novo resultado
...
exibir_resultado:
    ...
    ; Exibir a mensagem "Multiplicacao: "
    ...
    ; Converter o resultado para ASCII e exibir
    mov eax, [resultado]
    call exibir_numero
