...
section .bss
    ...
    resultado resd 1       ; Armazenar o resultado da divisao
...
ler_arquivo:
    ...
    jne continuar_divisao
    mov [resultado], eax
    mov byte [primeiro_numero], 0
    jmp ler_arquivo

continuar_divisao:
    ; Dividir pelo resultado total corretamente
    mov edx, 0              ; Limpar EDX para divisão segura
    mov ecx, eax            ; ECX = divisor
    mov eax, [resultado]    ; EAX = dividendo
    div ecx                 ; EAX = EAX / ECX
    mov [resultado], eax    ; Armazena o novo resultado
