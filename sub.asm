...
section .bss
    ...
    resultado resd 1       ; Armazenar o resultado da subtração
...
ler_arquivo:
    ...
    jne continuar_subtracao
    mov [resultado], eax
    mov byte [primeiro_numero], 0
    jmp ler_arquivo

continuar_subtracao:
    ; Subtrair do resultado total
    sub [resultado], eax
